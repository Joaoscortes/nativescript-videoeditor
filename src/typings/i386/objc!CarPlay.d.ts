...
declare class CPEntity extends NSObject implements NSSecureCoding {

	static alloc(): CPEntity; // inherited from NSObject

	static new(): CPEntity; // inherited from NSObject
...
declare class CPNowPlayingTemplate extends CPTemplate {
	...
	static sharedTemplate: CPNowPlayingTemplate;
